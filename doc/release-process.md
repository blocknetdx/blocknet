...
###tag version in git
	...
	git tag -s v(new version, e.g. 2.1.3.2)

###write release notes. git shortlog helps a lot, for example:

	git shortlog --no-merges v(current version, e.g. 2.1.3.0)..v(new version, e.g. 2.1.3.2)
...
###perform gitian builds
 ...
 From a directory containing the darknet source, gitian-builder and gitian.sigs
	...
	export VERSION=(new version, e.g. 2.1.3.2)
	pushd ./darknet
