...
* Update translations (ping @hanniabu on [Discord](https://discord.gg/2e6s7H8)) see [translation_process.md](https://github.com/BlocknetDX/blocknet/blob/master/doc/translation_process.md#synchronising-translations).
...
### Blocknet maintainers/release engineers, suggestion for writing release notes
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/BlocknetDX/blocknet/releases/new) with a link to the archived release notes.
