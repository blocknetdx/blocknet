...
Clone the git repositories for phore and gitian and then checkout the phore version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/phore-crypto/phore.git
cd phore
...
Follow the instructions in [doc/release-process.md](release-process.md) in the phore repository
...
```bash
    ...
    From https://github.com/phore-crypto/phore
...
[phore/gitian.sigs](https://github.com/phore-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
