...
In order to support loading of multiple wallets in blocknetdx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blocknetdx.cpp.
...
Changes to blocknetdx.cpp
----------------------
blocknetdx.cpp is the entry point into blocknetdx-qt, and as such, will require some minor modifications to provide hooks for
