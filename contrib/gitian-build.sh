...
VERSION=
commit=false
url=https://github.com/BlocknetDX/blocknet
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/BlocknetDX/blocknet
...
then
    ...
    #TODO Repo? git clone https://github.com/BlocknetDX/BlockDX-detached-sigs.git
