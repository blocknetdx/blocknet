...
This means one can have an always-on darknetd instance running, and another local darknetd/darknet-qt instance which connects to this node and receives blocks from it.
