...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default=os.path.normpath(os.path.dirname(os.path.realpath(__file__)) + "/../../../src"),
                          help="Source directory containing phored/phore-cli (default: %default)")
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use phore-cli instead of RPC for all commands")
    ...
    def add_nodes(self, num_nodes, extra_args=None, rpchost=None, timewait=None, binary=None):
        ...
        for i in range(num_nodes):
            ...
            self.nodes.append(TestNode(i, get_datadir_path(self.options.cachedir, i), rpchost=rpchost, timewait=timewait, binary=binary[i], stderr=None, mocktime=self.mocktime, coverage_dir=self.options.coveragedir, extra_conf=extra_confs[i], extra_args=extra_args[i], use_cli=self.options.usecli))
    ...
    def stop_node(self, i):
        """Stop a phored test node"""
        self.nodes[i].stop_node()
        self.nodes[i].wait_until_stopped()

    def stop_nodes(self):
        """Stop multiple phored test nodes"""
        for node in self.nodes:
    ...
    def _initialize_chain(self):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("PHORED", "phored"), "-datadir=" + datadir]
                if i > 0:
            ...
            for i in range(2):
                for peer in range(4):
                    for j in range(25):
                        ...
                        self.nodes[peer].setgenerate(True, 1)
                        block_time += 1 * 60
