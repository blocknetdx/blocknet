...
BOOST_AUTO_TEST_CASE(rpc_addmultisig)
{
    ...
    BOOST_CHECK(IsValidDestinationString(v.get_str()) && address.which() != 0);
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage PRgtiCnHnxcNVfRbGttX9EfNJpuZcTodY7 mymessage"), runtime_error);
    ...
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage PRgtiCnHnxcNVfRbGtXX9EfNJpuZcTodY7 " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage PRgtiCnHnxcNVfRbGttX9EfNJpuZcTodY7 " + retValue.get_str() + " mymessage").get_bool() == false);
