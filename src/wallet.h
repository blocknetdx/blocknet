...
public:
    ...
    void AvailableCoins2(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true) const;
    ...
    std::string SendMoneyToDestinationAnon(const CTxDestination &address, int64 nValue);
