...
void RelayDarkSendElectionEntryPing(const CTxIn vin, const std::vector<unsigned char> vchSig, const int64 nNow, const bool stop);nNow, const CPubKey pubkey, const int count, const int current);
