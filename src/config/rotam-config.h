/* src/config/rotam-config.h.  Generated from rotam-config.h.in by configure.  */
/* src/config/rotam-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ROTAM_CONFIG_H

#define ROTAM_CONFIG_H
