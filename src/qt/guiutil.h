...
/** Utility functions used by the Rotam Qt UI.
 */
namespace GUIUtil
{
...
// Render Rotam addresses in monospace font
...
// Parse "rotam:" URI into recipient object, return true on successful parsing
