 ...
 * @param parent
 */
BlocknetAddressEditor::BlocknetAddressEditor(int width, QTextEdit *parent) : QTextEdit(parent) {
...
void BlocknetAddressEditor::addAddress(QString addr) {
    ...
    const qreal r = 16; // border radius
    const qreal pad = 4;
    const qreal cw = 24; // left circle's width
    const qreal cwpad = 5;
