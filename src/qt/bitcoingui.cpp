                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Rotam Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rotam address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rotam: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Rotam Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rotam Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rotam"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rotam addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rotam addresses"));
    ...
    openAction->setStatusTip(tr("Open a Rotam: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rotam Core help message to get a list with possible Rotam command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Rotam Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rotam network", "", count));
}
...
{
    QString strTitle = tr("Rotam Core"); // default title
