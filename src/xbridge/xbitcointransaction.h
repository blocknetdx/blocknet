...
public:
    ...
    /**
     * @brief CTransaction - default constructor, reset all fieds
     */
    CTransaction()
    {
        SetNull();
    ...
    /**
     * @brief clone
     * @return  copy of currents transactions
     */
...
public:
    /**
     * @brief CXCTransaction - default constructor
     */
    ...
    /**
     * @brief clone clone this transaction
     * @return clone of transaction
     */
    virtual CTransactionPtr clone()
    {
        return CTransactionPtr(new CTransaction(*this));
...
public:
    /**
     * @brief CTransactionSignatureSerializer - construct new instance
     * @param txToIn -
     * @param scriptCodeIn
     * @param nInIn
     * @param nHashTypeIn
