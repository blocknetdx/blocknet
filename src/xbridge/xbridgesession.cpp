...
bool Session::Impl::processTransaction(XBridgePacketPtr packet) const
{
    ...
    offset += 8;
    int256_t samount = *static_cast<boost::int256_t *>(static_cast<void *>(packet->data()+offset));
    offset += sizeof(int256_t);
    ...
    offset += 8;
    int256_t damount = *static_cast<int256_t *>(static_cast<void *>(packet->data()+offset));
    offset += sizeof(int256_t);

    int256_t timestamp = *static_cast<int256_t *>(static_cast<void *>(packet->data()+offset));
    offset += sizeof(int256_t);
    ...
    int256_t minFromAmount = *static_cast<int256_t *>(static_cast<void *>(packet->data()+offset));
    offset += sizeof(int256_t);
...
bool Session::Impl::processPendingTransaction(XBridgePacketPtr packet) const
{
    ...
    offset += 8;
    int256_t samount = *reinterpret_cast<boost::int256_t *>(packet->data()+offset);
    offset += sizeof(int256_t);

    std::string dcurrency = std::string(reinterpret_cast<const char *>(packet->data()+offset));
    offset += 8;
    int256_t damount = *reinterpret_cast<boost::int256_t *>(packet->data()+offset);
    offset += sizeof(int256_t);
    ...
    if (ptr && ptr->state != TransactionDescr::trCancelled)
    {
        ...
        offset += sizeof(int256_t);           // created time
        ...
        int256_t minFromAmount = *reinterpret_cast<boost::int256_t *>(packet->data()+offset);
    ...
    ptr->created      = xbridge::intToTime(*reinterpret_cast<boost::int256_t *>(packet->data()+offset));
    offset += sizeof(int256_t);
...
bool Session::Impl::processTransactionAccepting(XBridgePacketPtr packet) const
{
    ...
    std::string scurrency((const char *)packet->data()+offset);
    offset += 8;
    int256_t samount = *static_cast<int256_t *>(static_cast<void *>(packet->data()+offset));
    offset += sizeof(int256_t);
...
bool Session::Impl::processTransactionInit(XBridgePacketPtr packet) const
{
    ...
    offset += 8;
    int256_t      fromAmount(*reinterpret_cast<int256_t *>(packet->data()+offset));
    offset += sizeof(int256_t);
    ...
    offset += 8;
    int256_t      toAmount(*reinterpret_cast<int256_t *>(packet->data()+offset));
    offset += sizeof(int256_t);
