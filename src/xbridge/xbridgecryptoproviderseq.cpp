...
//*****************************************************************************
//*****************************************************************************
SeqCryptoProvider::SeqCryptoProvider()
{
...
//*****************************************************************************
//*****************************************************************************
bool SeqCryptoProvider::check(const std::vector<unsigned char> & key)
{
...
//*****************************************************************************
//*****************************************************************************
void SeqCryptoProvider::makeNewKey(std::vector<unsigned char> & key)
{
    key.resize(32);
    do
    {
...
//*****************************************************************************
//*****************************************************************************
bool SeqCryptoProvider::getPubKey(const std::vector<unsigned char> & key, std::vector<unsigned char> & pub)
{
...
//******************************************************************************
//******************************************************************************
bool SeqCryptoProvider::sign(const std::vector<unsigned char> & key,
                             const uint256 & data,
...
//    RFC6979_HMAC_SHA256 prng(&key[0], 32, data.begin(), 32);
//    do {
//        uint256 nonce;
//        prng.Generate((unsigned char*)&nonce, 32);
//        nonce += test_case;
//        int nSigLen = 72;
//        int ret = secp256k1_ecdsa_sign((const unsigned char*)&hash, 32, (unsigned char*)&vchSig[0],
//                                        &nSigLen, begin(), (unsigned char*)&nonce);
//        nonce = 0;
//        if (ret) {
...
//******************************************************************************
//******************************************************************************
bool SeqCryptoProvider::verify(const std::vector<unsigned char> & pubkey,
                               const uint256 & data,
