...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed1.blocknet.org");
        vSeeds.emplace_back("seed2.blocknet.org");
        vSeeds.emplace_back("seed3.blocknet.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed1.blocknet.org");
        vSeeds.emplace_back("testnet-seed2.blocknet.org");
